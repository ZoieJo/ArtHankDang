					...
					<div class="row">
						...
						<div class="col-sm-12">
							<div class="card">
								<div class="card-header">
									<h5>Inverse Table</h5>
									<span>Use a class <code>table-inverse</code> inside
										table element.
									</span>
								</div>
								<div class="table-responsive">
							...
							<div class="card">
								<div class="card-header">
									...
									<span>Use a class <code>.bg-info, .bg-success,
											.bg-warning and .bg-danger classes.</code> with light text on dark
										backgrounds inside table element.<br>To set the light
										background color use .bg-[color] class where [color] is the
										value of your selected color from stack color palette. So for
										teal color background class will be .bg-teal
									</span>
								</div>
								<div class="table-responsive">
						...
						<div class="col-sm-12">
							<div class="card">
								<div class="card-header">
									...
									<span>Use a class <code>table-hover</code> to enable a
										hover state on table rows within a <code>tbody</code>.
									</span>
								</div>
								<div class="table-responsive">
						...
						<div class="col-sm-12">
							<div class="card">
								<div class="card-header">
									...
									<span>Use contextual classes to color table rows or
										individual cells. you may use Classes <code>table-primary</code>,<code>table-secondary</code>,<code>table-success</code>,<code>table-info</code>,<code>table-warning</code>,<code>table-danger</code>,<code>table-light</code>,<code>table-active</code>
										in<code>tr</code>
									</span>
								</div>
								<div class="table-responsive">
						...
						<div class="col-sm-12">
							<div class="card">
								<div class="card-header">
									...
									<span>Regular table background variants are not
										available with the inverse table, however, you may use Classes
						...
						<div class="col-sm-12">
							<div class="card">
								<div class="card-header">
									...
									<span>Similar to tables and dark tables, use the
										modifier classes <code>.thead-dark</code> to make <code>thead</code>
						...
						<div class="col-sm-12">
							<div class="card">
								<div class="card-header">
									<h5>Table head options</h5>
									<span>Similar to tables and dark tables, use the
										modifier classes <code>.bg-*</code>and <code>.thead-light</code>
										to make <code>thead</code> appear light or dark gray.
									</span>
								</div>
								<div class="card-block row">
									<div class="col-sm-12 col-lg-12 col-xl-12">
						...
						<div class="col-sm-12">
							<div class="card">
								<div class="card-header">
									<h5>Striped Row</h5>
									<span>Use <code>.table-striped</code> to add
										zebra-striping to any table row within the <code></code>. This
										styling doesn't work in IE8 and below as :nth-child CSS
						...
						<div class="col-sm-12">
							<div class="card">
								<div class="card-header">
									<h5>Caption</h5>
									<span>A <code>&lt;caption&gt;</code> functions like a
										heading for a table. It helps users with screen readers to
						...
						<div class="col-sm-12">
							<div class="card">
								<div class="card-header">
									...
									<span>Use <code>.table-responsive{-sm|-md|-lg|-xl}</code>
