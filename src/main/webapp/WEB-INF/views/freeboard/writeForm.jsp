...
<div class="container-fluid">
	...
	<div class="container-fluid">
		...
		<div class="card">
			<div class="card-body">
				<form class="needs-validation" id="fb_form" action="${CONTEXT_PATH}/freeboard/write" method="post">
				  <div class="row">
					...
					<textarea id="editor1" name="bdCNT" cols="30" rows="10"
						required="required">
					</textarea>
					<sec:csrfInput />
					<div style="float: right;">
						<button class="btn btn-primary active" type="submit"
							style="margin: 10px;" id="id_insertbtn">저장</button>
						<button id="id_backbtn" class="btn btn-info active" type="button"
							style="margin: 10px;"
