		...
		<div class="row">
			<div class="col-sm-6">
				...
				<ol class="breadcrumb">
					...
					<li class="breadcrumb-item">임시보관함</li>
				</ol>
			</div>
		</div>
	</div>
			...
			<div class="card">
				...
				<div class="card-body" style="padding-top: 0px;">
					<table class="table" style="text-align: center;">
						...
						<tbody>
							<c:forEach var="tmpVO" items="${tmpList}" varStatus="status">
								<tr onclick="location.href='${CONTEXT_PATH}/aprl/draftinPaper?aprldocNo=${tmpVO.aprldocNo}'">
									<td>${status.index + 1}</td>
									<td>${tmpVO.aprldocNo}</td>
									<td><fmt:formatDate value="${tmpVO.aprldocWtDt}" pattern="yyyy-MM-dd"/></td>
									<td>${tmpVO.aprldocTl}</td>
									<td>
										<c:if test="${tmpVO.aprlStCd.equals('01')}">
											임시저장
										</c:if>
									</td>
								</tr>
