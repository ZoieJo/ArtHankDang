    ...
    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        <%@ taglib prefix="sec" uri="http://www.springframework.org/security/tags" %>
            <%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
                                ...
                                <form id="id_editForm">
                                    <div class="mb-3">
                                        ...
                                        <input id="datePicker" name="atdDt"
                                            class="form-control datepicker-here form-control digits" type="text" data-language='ko'
                                            value="">
                                    </div>
                                    <div class="mb-3">
                ...
                <script src="${CONTEXT_PATH}/assets/js/datepicker/date-picker/datepicker.ko.js"></script>
