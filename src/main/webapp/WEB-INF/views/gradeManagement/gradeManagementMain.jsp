                                    ...
                                    <table class="table table-hover" style="text-align: center;">
                                        ...
                                        <tbody>
                                            <c:forEach var="curs" items="${cursList}" varStatus="status">
                                                <tr onclick="location.href='${CONTEXT_PATH}/grdManagement/list?cursNo=${curs.cursNo}'">
                                                    ...
                                                    <c:set target="${now}" property="time" value="${now.time + (86400000 * 10)}" />
                                                        ...
                                                        <td>${curs.subNm}</td>
                                                        <td>${curs.cursNm}
                                                            <c:if test="${curs.cursEndDt le now}">
                                                            <span class="badge rounded-pill badge-primary">성적 입력</span>
                                                            </c:if>
