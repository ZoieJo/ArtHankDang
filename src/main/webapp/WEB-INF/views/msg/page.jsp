	      	...
	      	<div class="card">
				<div class="card-body chat-body" style="height:auto; word-break:break-all; overflow: auto;">
					...
					<div class="chat-box">
	                  ...
	                  <hr>
	                    <!-- 직원 목록 뿌리기 -->
	                    <div class="people-list" id="people-list" style="padding-bottom: 10px;">
	                    	<span style="font-size: 15px;color: rgb(70, 70, 70);font-weight: bold; display: inline;">
	                    	<button type="button" class="btn btn-info btn-xs" id="emplistBtn">교직원 주소록</button>
	                    	</span>
	                    	
	                    	<span style="font-size: 15px;color: rgb(70, 70, 70);font-weight: bold; display: inline;">
	                    	<button type="button" class="btn btn-info btn-xs" id="stulistBtn">수강학생 주소록</button>
	                    	</span>
	                    </div>
					</div>
	                <!-- Chat left side Ends-->
					...
					<!-- 트리구조 -->
					<div id="treecheckbox" class="jstree jstree-2 jstree-default jstree-checkbox-selection" role="tree" aria-multiselectable="true"
					 tabindex="0" aria-activedescendant="j2_4" aria-busy="false" aria-selected="false">
						<ul class="jstree-container-ul jstree-children" id="emplistUl" role="group" >
							<li role="treeitem" aria-selected="true" aria-level="1" aria-labelledby="allEmp_anchor" aria-expanded="true" 
							id="allEmp" class="jstree-node jstree-open" style="display: none;">
							     ...
							     <ul role="group" class="jstree-children" style="">
							          <!-- 관리 부서 -->
							          <li role="treeitem" data-jstree="{&quot;opened&quot;:true}" aria-selected="false" aria-level="2" aria-labelledby="management_anchor" 
							          aria-expanded="true" id="management" class="jstree-node jstree-open jstree-last">
							               <i class="jstree-icon jstree-ocl" role="presentation"></i>
							               ...
							               <ul role="group" class="jstree-children">
				               	                <c:forEach var="item" items="${emplist}"  varStatus="status">
		                							<c:if test="${item.empDepNm  eq 'MAN'}">
									                    <li role="treeitem" data-jstree="{&quot;type&quot;:&quot;file&quot;}" aria-selected="false" aria-level="3" 
									                    aria-labelledby="${item.empPhNo}_${status.count}" class="jstree-node jstree-leaf">
									                         <i class="jstree-icon jstree-ocl" role="presentation"></i>
									                         <a  class="jstree-anchor" href="#" tabindex="-1" id="${item.empPhNo}_${status.count}" >
										                         <i class="jstree-icon jstree-checkbox" role="presentation"></i>
							          ...
							          <!-- 교육 부서 -->
							          <li role="treeitem" data-jstree="{&quot;opened&quot;:true}" aria-selected="false" aria-level="2" aria-labelledby="education_anchor"
							           aria-expanded="true" id="education" class="jstree-node  jstree-open jstree-last">
							               <i class="jstree-icon jstree-ocl" role="presentation"></i>
							               ...
							               <ul role="group" class="jstree-children">
											<c:forEach var="item" items="${emplist }" varStatus="status">
								               <c:if test="${item.empDepNm  eq 'EDU'}">
								                   <li role="treeitem" data-jstree="{&quot;type&quot;:&quot;file&quot;}" aria-selected="false" aria-level="3" 
								                   aria-labelledby="${item.empPhNo}_${status.count}" id="${item.empId }"
							...
							<!-- 학생주소록 시작 -->
							<li role="treeitem" aria-selected="false" aria-level="1" aria-labelledby="allStu_anchor" style="display: none;"
							 aria-expanded="false" id="allStu" class="jstree-node jstree-open">
								<i class="jstree-icon jstree-ocl" role="presentation"></i>
						...
						<div class="row">
							<div class="col">
								<div>
									...
									<textarea class="form-control" id="exampleFormControlTextarea4" name="msgCnt" rows="13" 
...
<script>
	document.getElementById("emplistBtn").addEventListener("click", function(){
		$("#allEmp"). css("display", "block");
		$("#allStu"). css("display", "none");
	})
	document.getElementById("stulistBtn").addEventListener("click", function(){
		$("#allEmp"). css("display", "none");
		$("#allStu"). css("display", "block");
		$("#allStu"). attr("class", "jstree-node jstree-open");
	})
...
// ==================================================================================================================
	...
	$("#msgSend").on("click", function () {
		$.ajax({
			url : '${CONTEXT_PATH}/msg/employee/page',
			headers: {
