if(localStorage.getItem("color"))
    $("#color" ).attr("href", "/arthakdang/assets/css/"+localStorage.getItem("color")+".css" );
...
$(document).ready(function () {
      $(".customizer-color li").on('click', function() {
        ...
        $("#color" ).attr("href", "/arthakdang/assets/css/"+color+".css" );
    ...
    $('.sidebar-type li').on('click', function () {
        ...
        switch (type) {
            ...
            case 'normal-sidebar': {
                ...
                $(".logo-wrapper").find('img').attr('src', '/arthakdang/assets/images/logo/logo.png');
